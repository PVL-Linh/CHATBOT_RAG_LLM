...
from app.config.config_HR import (
    ...
    ORG_FULLCOPY_HR, JD_FULLCOPY_HR,
    ORG_SOURCE_HINT_HR,
)
from app.config.paths import DATA_DIR_HR, GEMINI_MODEL_ANSWER_HR, GEMINI_MODEL_JUDGE_HR
...
def _qr_llm_aliases(question: str) -> List[str]:
    ...
    try:
        ...
        prompt = f"""Sinh tối đa {QR_NUM_ALIASES_HR} alias ngắn (<=10 từ) cho câu sau, tiếng Việt/Anh.
            CÂU: "{question}"
