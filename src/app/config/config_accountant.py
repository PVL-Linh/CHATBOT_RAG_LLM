...
# load_dotenv()
# ---------- retrieval ----------
RAG_TOPK_ACCOUNTANT   = _env_int ("RAG_TOPK_ACCOUNTANT",   "40")
...
QR_LLM_MODEL_ACCOUNTANT   = _env_get  ("QR_LLM_MODEL_ACCOUNTANT","gemini-2.0-flash")
...
# full-copy & mini llm
ORG_FULLCOPY_ACCOUNTANT  = _env_bool("ORG_FULLCOPY_ACCOUNTANT","1")
JD_FULLCOPY_ACCOUNTANT   = _env_bool("JD_FULLCOPY_ACCOUNTANT","1")
FORM_FULLCOPY_ACCOUNTANT = _env_bool("FORM_FULLCOPY_ACCOUNTANT","0")

MINI_LLM_ON_FULLCOPY_ACCOUNTANT = _env_bool("MINI_LLM_ON_FULLCOPY_ACCOUNTANT","1")
