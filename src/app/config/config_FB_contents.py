...
API_KEY_MKT_FB = os.environ.get("GEMINI_API_KEY_FB")
if not API_KEY_MKT_FB:
    raise RuntimeError("Không tìm thấy GEMINI_API_KEY_FB trong .env")
...
TEXT_MODEL_MKT_FB  = os.environ.get("GEMINI_TEXT_MODEL_FB", "gemini-2.5-flash")  # FREE
