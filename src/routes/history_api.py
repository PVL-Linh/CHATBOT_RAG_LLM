...
from services.history import read_sessions_and_messages, get_history, MAX_HISTORY
...
def api_history_sessions():
    ...
    for sid, msgs in sessions.items():
        ...
        out.append({"id": sid, "title": title, "count": len(msgs), "first_ts": msgs[0]["ts"], "last_ts": msgs[-1]["ts"]})
