...
# from .config_MKT import CLIENT_MKT, GEMINI_IMAGE_MODEL, IMAGEN_MODEL
...
def build_image_prompt(
    ...
    # Get occasion-specific elements
...
def add_logo_to_images(
    ...
    for img in images:
        ...
        # Paste logo at top-left corner with margin
...
def load_default_logo(app_root_path: str) -> Optional[Image.Image]:
    """Load default logo from static/images/logo.png"""
